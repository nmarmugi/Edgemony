function Card({cardId, cardImg, cardTitle, cardPrice, cardCategory, onClick, buttonMessage, clickCard}) {
	return (
		<div onClick={clickCard} className="cursor-pointer pb-8 w-72 min-w-72 h-96 max-h-96 border flex flex-col rounded-lg overflow-hidden shadow-md" id={cardId}>
